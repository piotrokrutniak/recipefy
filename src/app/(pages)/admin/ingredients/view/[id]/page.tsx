      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-8">
          <div className="flex flex-col gap-4 w-32">
            <p className="flex justify-between place-items-center gap-2 font-semibold">
              {" "}
              Vegan:{" "}
              {ingredient?.vegan ? (
                <FaCheckCircle className="w-5 h-5 fill-green-500" />
              ) : (
                <BsXCircleFill className="w-5 h-5 fill-red-500" />
              )}{" "}
            </p>
            <p className="flex justify-between place-items-center gap-2 font-semibold">
              {" "}
          ...
          <div className="flex flex-col gap-4">
            <p className="flex whitespace-nowrap w-44 justify-between place-items-center gap-2">
              ...
              {ingredient?.updatedAt ? ParseDate(ingredient?.updatedAt) : " "}{" "}
            </p>
            <p className="flex whitespace-nowrap w-44 justify-between place-items-center gap-2">
              {" "}
              <span className="font-semibold">Created:</span>{" "}
              {ingredient?.createdAt ? ParseDate(ingredient?.createdAt) : " "}{" "}
            </p>
          </div>
        </div>
