...
export default function ViewIngredientPage({params}: {params: { id: string } }){
    ...
    return( 
        <>
            <form id="admin-ingredient-view-section" className='max-w-4xl bg-slate-500/30 mx-auto w-full max-mobile:p-4 p-8 rounded-xl shadow-md shadow-black/40 flex flex-col gap-6' onSubmit={(e) => submitAction(e)}>
                <div className="flex flex-col sm:flex-row justify-between sm:place-items-start gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="flex whitespace-nowrap place-items-center gap-2"> <span className="font-semibold">Updated:</span> {/*ingredient?.updated ??*/ "Missing data"} </p>
                        <p className="flex whitespace-nowrap place-items-center gap-2"> <span className="font-semibold">Created:</span> {/*ingredient?.created ??*/ "Missing data"} </p>
                    </div>
                </div>
