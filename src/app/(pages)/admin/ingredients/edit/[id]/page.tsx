  ...
  return (
    <>
      <form
        ...
        className="max-w-4xl bg-slate-500/30 mx-auto w-full max-mobile:p-4 p-8 rounded-xl shadow-md shadow-black/40 flex flex-col gap-4"
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:place-items-start gap-4">
          ...
          <div className="flex flex-col gap-2 pt-2">
            <p className="flex whitespace-nowrap w-44 justify-between place-items-center gap-2">
              {" "}
              <span className="font-semibold">Updated:</span>{" "}
              {ingredient?.updatedAt ? ParseDate(ingredient?.updatedAt) : "Unknown"}{" "}
            </p>
            <p className="flex whitespace-nowrap w-44 justify-between place-items-center gap-2">
              {" "}
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-6">
          <div className="flex flex-col gap-6 w-36">
            <div className="flex justify-between place-items-center gap-4 pl-2">
              {" "}
              Vegan <FormCheckbox value={ingredient.vegan} updateValue={setVegan} />{" "}
            </div>
            <div className="flex justify-between place-items-center gap-4 pl-2">
              {" "}
              Vegetarian <FormCheckbox
                value={ingredient.vegetarian}
