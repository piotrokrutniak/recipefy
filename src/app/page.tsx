    ...
    <>
      ...
      >
        <h1 className="flex gap-2 justify-between text-white place-items-center">
          ...
          <LinkButton href={"/recipes"} className="text-white bg-transparent border-2 border-slate-200/20 hover:border-transparent active:bg-slate-100/5 hover:bg-indigo-500">
            Przepisy
          </LinkButton>
        </h1>
        <TopPicks />
