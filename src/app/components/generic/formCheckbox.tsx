export default function FormCheckbox({className, label, defaultValue = false, value, updateValue, inputClassName}: {
    className?: string,
    label?: string,
    ...
    return(
        <div className={`${className ?? ""} flex flex-row gap-2 justify-between place-items-center`}>
            ...
            <input type="checkbox" defaultChecked={defaultValue || false} onChange={() => Toggle(value)}
